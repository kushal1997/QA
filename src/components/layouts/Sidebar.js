...
export const Sidebar = () => {
    ...
    return (
        <div className=' bg-gray-900 '>
            <>
                <span
                    className="absolute text-white text-4xl top-1 left-4 cursor-pointer"
                    onClick={sidebar}
                >
                ...
                <div className="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-slate-900 ">
                    <div className="text-gray-100 text-xl">
                        <div className="p-1 m-2 flex items-center ">
                            <a href="https://www.dayacs.com/" target='blanck'>
                                <img width="170" height="17" src="https://www.dayacs.com/images/logoupDCS.png" alt="logo-img"></img>
                    ...
                    <div className={inforSubMenu ? 'show, bg-slate-700' : 'hidden'}>
                        <div
