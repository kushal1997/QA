...
export const Contact = () => {
  ...
  return (
    ...
    <main className=" p-3 h-screen bg-[#030321]">
        ...
        <div className='flex justify-center '>
          ...
          <div className='flex justify-center mt-10'>
            <div className='container'>
              <div className={submitted ? 'hidden' : 'show'}>
                <form ref={form} onSubmit={handleFormSubmit}>
                  ...
                  <div className='ui-form'>
                    <div className='field'>
                      ...
                      <input className='input' type='text' name='from_name' placeholder='Full Name' />
                      <label>Email Id </label>
                      <input className='input' type='Email' name='email_add' placeholder='Email Id' />
                      <label>Phone </label>
                      <input className='input' type='tel' name='ph_num' placeholder='Phone no' />
              ...
              <div className={submitted ? 'show' : 'hidden'}>
